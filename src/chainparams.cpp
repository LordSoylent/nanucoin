...
// Copyright (c) 2015-2017 The NanuCoin developers
...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1533932431, // * UNIX timestamp of last checkpoint block
...
public:
    ...
    CMainParams() {
        ...
        nDefaultPort = 11923;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // NanuCoin starting difficulty is 1 / 2^12 = ~uint256(0) >> 15; // NanuCoin starting difficulty is 1 / 2^12
...
public:
    ...
    CTestNetParams() {
        ...
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("nanu.ddns.net", "nanu.ddns.net"));
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet nanucoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19); // Testnet nanucoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239); // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet nanucoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet nanucoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet nanucoin BIP44 coin type is '1' (All coin's testnet default)
...
public:
    ...
    CRegTestParams() {
        ...
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // NanuCoin: 1 day
        nTargetSpacing = 1 * 60; // NanuCoin: 1 minutes
