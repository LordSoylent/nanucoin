                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NanuCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NanuCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nanucoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NanuCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about NanuCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NanuCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NanuCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NanuCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a NanuCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NanuCoin Core help message to get a list with possible NanuCoin command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NanuCoin network", "", count));
}
